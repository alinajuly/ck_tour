...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/master.key', 'config/puma.rb', 'config/secrets.yml', 'config/credentials.yml' )
...
set :config_files, %w[config/database.yml config/secrets.yml config/credentials.yml]
