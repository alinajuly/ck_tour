...
ActiveRecord::Schema[7.0].define(version: 20_230_430_145_134) do
  ...
  create_table 'geolocations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[geolocationable_type geolocationable_id], name: 'index_geolocations_on_geolocationable'
  end
  ...
  create_table 'rates', force: :cascade do |t|
    ...
    t.index %w[ratable_type ratable_id], name: 'index_rates_on_ratable'
