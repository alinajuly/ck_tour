...
6.times do
  Room.create(places: 2, bed: 'double',
              ...
              breakfast: true, no_smoking: false, price_per_night: 1690, accommodation_id: accommodation.id)
end

2.times do
  Room.create(places: 2, bed: 'double',
              description: 'Напівлюкс Ванна кімната в номері 32 кв. м Кондиціонер Вид на басейн',
              breakfast: true, no_smoking: false, price_per_night: 2690, accommodation_id: accommodation.id)
end

2.times do
  Room.create(places: 2, bed: 'double',
              description: 'Покращений двомісний номер  Ванна кімната в номері 32 кв. м Кондиціонер ',
              breakfast: true, no_smoking: false, price_per_night: 3290, accommodation_id: accommodation.id)
end

3.times do
  Room.create(places: 1, bed: 'one',
              description: 'Покращений одномісний номер  Ванна кімната в номері 23 кв. м Кондиціонер ',
              breakfast: true, no_smoking: true, price_per_night: 2790, accommodation_id: accommodation.id)
end

3.times do
  Room.create(places: 2, bed: 'double',
              description: 'Покращений двомісний номер  Ванна кімната в номері 23 кв. м Кондиціонер ',
              breakfast: true, no_smoking: true , price_per_night: 3290, accommodation_id: accommodation.id)
end
...
5.times do
  Room.create(places: 2, bed: 'double',
              ...
              breakfast: true, no_smoking: false, price_per_night: 3990, accommodation_id: accommodation.id)
end

5.times do
  Room.create(places: 3, bed: 'double+one',
              description: 'Сімейний люкс 40 кв. м Вид Кондиціонер ',
              breakfast: true, no_smoking: true, price_per_night: 4490, accommodation_id: accommodation.id)
end
